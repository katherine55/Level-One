...
public class SimonSays extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 		...
 		images.put(new Integer(KeyEvent.VK_UP), "down.png");
 		images.put(new Integer(KeyEvent.VK_UP), "left.png");
 ...
 showImage();
	...
	public void keyPressed(KeyEvent e) {
    	...
    	if(tries > 1){
    		System.out.println("Simon didn't say!!");
    		 System.out.println((new Date().getTime()-timeAtStart.getTime())/1000);
    		System.exit(0);
    		}
