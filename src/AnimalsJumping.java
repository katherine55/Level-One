...
public class AnimalsJumping {
	public static void main(String[] args) throws MalformedURLException {
		 ...
		 */
		JFrame frame = new JFrame("Dolphins");
		String urlOfAnimalSuckingAtJumping = "http://67.media.tumblr.com/7db96e7ae9e66567f618df29b5d07289/tumblr_mi9klfms3J1s612eao1_400.gif";
